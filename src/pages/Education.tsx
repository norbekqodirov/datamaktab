...
export default function Education() {
  ...
  return (
    <>
    <SEO url="/talim" title={e.hero_title} description={e.hero_desc} />
    <div className="bg-surface font-body text-on-surface">
      ...
      <section className="py-16 md:py-12 md:py-16 bg-white">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 text-[10px] font-extrabold tracking-[0.25em] text-[#062bad] bg-[#03caff]/10 rounded-full uppercase mb-5">{e.roadmap_badge}</span>
            <h2 className="font-headline text-4xl md:text-6xl font-extrabold text-primary tracking-tighter">
              {e.roadmap_title.split(' ').slice(0, -3).join(' ')} <span className="text-[#03caff]">{e.roadmap_title.split(' ').slice(-3).join(' ')}</span>
            </h2>
            <p className="mt-5 text-on-surface-muted max-w-2xl mx-auto text-lg">{e.roadmap_subtitle}</p>
          </div>
              ...
              <div key={i} className="flex flex-col rounded-[2rem] overflow-hidden shadow-lg border border-slate-100 bg-white hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 group">
                <div className="aspect-[16/9] relative bg-slate-100">
                  ...
                  <div className="absolute bottom-4 left-4 flex items-end gap-3">
                    ...
                    <span className="text-white/80 font-bold text-sm">{item.yosh}</span>
                  </div>
                </div>
          ...
          <div className="mt-16 p-8 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-3xl border border-primary/10">
            <h3 className="font-headline font-extrabold text-primary text-2xl mb-6 text-center">{e.methods_title}</h3>
      ...
      <section className="py-12 md:py-16 bg-surface">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="inline-block px-4 py-1.5 text-[10px] font-extrabold tracking-[0.25em] text-[#062bad] bg-[#03caff]/10 rounded-full uppercase mb-6">{e.lessons_badge}</span>
              <h2 className="font-headline text-4xl md:text-5xl font-extrabold text-primary mb-6">
                {e.lessons_title} <span className="text-[#03caff]">{e.lessons_accent}</span>
              </h2>
              <p className="text-on-surface-muted text-lg leading-relaxed mb-10">{e.lessons_desc}</p>
              <div className="space-y-5">
                {e.subjects.map((item, i) => (
                  <div key={i}>
                    <div className="flex justify-between mb-2">
                      <span className="font-semibold text-primary text-sm">{item.subject}</span>
                      <span className="font-bold text-sm" style={{ color: ['#062bad','#03caff','#041c80','#64748b'][i] }}>{item.pct}%</span>
                    </div>
                    <div className="h-3 bg-slate-100 rounded-full overflow-hidden">
                      <div className="h-full rounded-full" style={{ width: `${item.pct}%`, backgroundColor: ['#062bad','#03caff','#041c80','#64748b'][i] }} />
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="py-16 md:py-12 md:py-16 bg-white">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 text-[10px] font-extrabold tracking-[0.25em] text-[#062bad] bg-[#03caff]/10 rounded-full uppercase mb-5">{e.subjects_badge}</span>
            <h2 className="font-headline text-4xl md:text-6xl font-extrabold text-primary">{e.subjects_title}</h2>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="bg-surface rounded-3xl overflow-hidden shadow-xl border border-slate-100 flex flex-col h-full bg-slate-50 relative group">
              <div className="aspect-video relative bg-slate-100">
                <EditableImage src={get('edu_math_img', '/images/math.jpg')} alt={e.math_title} onSave={v => saveKey('edu_math_img', v)}
                  className="w-full h-full absolute inset-0" imgClassName="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                ...
                <div className="absolute bottom-5 left-6 pr-4">
                  <span className="text-white font-headline font-extrabold text-2xl drop-shadow-md">{e.math_title}</span>
                  <p className="text-[#03caff] text-xs font-bold uppercase tracking-widest mt-1 opacity-90 drop-shadow-md">{e.math_subtitle}</p>
                </div>
              </div>
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between bg-white">
                ...
                <div className="p-5 bg-[#062bad]/5 rounded-2xl border border-[#062bad]/10 mt-auto flex-shrink-0">
                  <p className="text-[10px] font-bold text-[#062bad] uppercase tracking-widest mb-3">{e.teachers_label}</p>
                  {e.math_teachers.map((t, i) => (
            ...
            <div className="bg-surface rounded-3xl overflow-hidden shadow-xl border border-slate-100 flex flex-col h-full bg-slate-50 relative group">
              <div className="aspect-video relative bg-slate-100">
                <EditableImage src={get('edu_eng_img', '/images/english.jpg')} alt={e.eng_title} onSave={v => saveKey('edu_eng_img', v)}
                  className="w-full h-full absolute inset-0" imgClassName="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#03caff] to-transparent pointer-events-none opacity-80" />
                <div className="absolute bottom-5 left-6 pr-4">
                  <span className="text-white font-headline font-extrabold text-2xl drop-shadow-md">{e.eng_title}</span>
                  <p className="text-white/90 text-xs font-bold uppercase tracking-widest mt-1 drop-shadow-md">{e.eng_subtitle}</p>
                </div>
              </div>
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between bg-white">
                <div className="space-y-4 mb-8 relative before:absolute before:inset-y-2 before:left-[5px] before:w-px before:bg-slate-100">
                  {e.eng_stages.map((item, i) => (
                    <div key={i} className="relative pl-6">
                ...
                <div className="p-5 bg-[#03caff]/5 rounded-2xl border border-[#03caff]/10 mt-auto flex-shrink-0">
                  <p className="text-[10px] font-bold text-[#03caff] uppercase tracking-widest mb-3">{e.teachers_label}</p>
                  {e.eng_teachers.map((t, i) => (
            ...
            <div className="bg-surface rounded-3xl overflow-hidden shadow-xl border border-slate-100 flex flex-col h-full bg-slate-50 relative group">
              <div className="aspect-video relative bg-slate-100">
                <EditableImage src={get('edu_it_img', '/images/it.jpg')} alt={e.it_title} onSave={v => saveKey('edu_it_img', v)}
                  className="w-full h-full absolute inset-0" imgClassName="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#041c80] to-transparent pointer-events-none opacity-80" />
                <div className="absolute bottom-5 left-6 pr-4">
                  <span className="text-white font-headline font-extrabold text-2xl drop-shadow-md">{e.it_title}</span>
                  <p className="text-[#03caff] text-xs font-bold uppercase tracking-widest mt-1 opacity-90 drop-shadow-md">{e.it_subtitle}</p>
                </div>
              </div>
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between bg-white">
                <div className="space-y-4 mb-8 relative before:absolute before:inset-y-2 before:left-[5px] before:w-px before:bg-slate-100">
                  {e.it_stages.map((item, i) => (
                    <div key={i} className="relative pl-6">
                ...
                <div className="p-5 bg-[#041c80]/5 rounded-2xl border border-[#041c80]/10 mt-auto flex-shrink-0">
                  <p className="text-[10px] font-bold text-[#041c80] uppercase tracking-widest mb-3">{e.teachers_label}</p>
                  {e.it_teachers.map((t, i) => (
      ...
      <section className="py-12 md:py-16 bg-gradient-to-r from-primary via-[#041c80] to-secondary">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-white/70 max-w-2xl mx-auto text-lg">{e.certs_subtitle}</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/10 border border-white/20 rounded-3xl p-8 flex items-start gap-6">
              ...
              <div>
                <h3 className="font-headline font-extrabold text-white text-2xl mb-2">{e.sat_title}</h3>
                <p className="text-white/70 text-sm leading-relaxed">{e.sat_desc}</p>
              </div>
            </div>
            <div className="bg-white/10 border border-white/20 rounded-3xl p-8 flex items-start gap-6">
              <div className="w-16 h-16 rounded-2xl bg-[#03caff]/20 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <h3 className="font-headline font-extrabold text-white text-2xl mb-2">{e.ielts_title}</h3>
                <p className="text-white/70 text-sm leading-relaxed">{e.ielts_desc}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            <div className="flex flex-col justify-between py-2">
              <div className="mb-6">
                <span className="inline-block px-4 py-1.5 text-[10px] font-extrabold tracking-[0.25em] text-[#062bad] bg-[#03caff]/10 rounded-full uppercase mb-6">{e.olympiads_badge}</span>
                <h2 className="font-headline text-3xl md:text-5xl font-extrabold text-primary mb-4 leading-tight">{e.olympiads_title.split(' ').slice(0,-1).join(' ')} <span className="text-[#03caff]">{e.olympiads_title.split(' ').slice(-1)}</span></h2>
                <p className="text-on-surface-muted leading-relaxed text-base">{e.olympiads_desc}</p>
              </div>
              <div className="overflow-hidden rounded-3xl border border-slate-100 shadow-sm mt-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gradient-to-r from-primary to-[#041c80] text-white">
                    <tr>
                      {e.table_head.map((h, i) => (
                        <th key={i} className="text-left p-4 font-bold text-xs uppercase tracking-widest leading-relaxed">{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="flex flex-col gap-6 h-full">
              <div className="relative flex-1 rounded-[2.5rem] overflow-hidden shadow-2xl group bg-slate-100 min-h-[300px]">
                ...
                <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8">
                  <p className="text-white font-bold text-xs uppercase tracking-widest mb-1">{e.olympiads_years}</p>
                  <p className="text-white font-headline font-extrabold text-2xl md:text-3xl">{e.olympiads_result_label}</p>
                </div>
              </div>
              {/* BOND badge */}
              <div className="p-6 md:p-8 bg-gradient-to-r from-[#062bad] to-[#03caff] rounded-3xl text-white flex-shrink-0 shadow-xl shadow-[#062bad]/20">
                <h3 className="font-headline font-extrabold text-2xl mb-2">{e.bond_title}</h3>
                <p className="text-white/80 text-sm leading-relaxed mb-6">{e.bond_desc}</p>
      ...
      <section className="py-16 md:py-12 md:py-16 bg-surface">
        <div className="max-w-[1440px] mx-auto px-6 md:px-16">
          <div className="text-center mb-16">
            <span className="inline-block px-4 py-1.5 text-[10px] font-extrabold tracking-[0.25em] text-[#062bad] bg-[#03caff]/10 rounded-full uppercase mb-5">{e.clubs_badge}</span>
            <h2 className="font-headline text-4xl md:text-6xl font-extrabold text-primary">{e.clubs_title}</h2>
            <p className="mt-4 text-on-surface-muted max-w-2xl mx-auto text-lg">{e.clubs_subtitle}</p>
          </div>
          ...
          <div className="mt-12 p-7 bg-white rounded-3xl border border-slate-100 shadow-sm">
            <h3 className="font-headline font-extrabold text-primary text-lg mb-4">{e.clubs_upcoming_title}</h3>
            <div className="flex flex-wrap gap-3">
              {e.clubs_upcoming.map((item, i) => (
                <span key={i} className="px-4 py-2 bg-[#03caff]/10 text-[#062bad] rounded-full text-sm font-bold border border-[#03caff]/20">{item}</span>
              ))}
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            <div className="relative h-full min-h-[460px] w-full rounded-[2.5rem] md:rounded-[3rem] overflow-hidden shadow-2xl group bg-slate-100">
              ...
              <div className="absolute top-6 right-6 bg-[#03caff] text-white px-5 py-3 rounded-2xl shadow-lg">
                <p className="font-headline font-extrabold text-xl">{e.montessori_badge_year}</p>
                <p className="text-[10px] md:text-xs uppercase tracking-widest opacity-90 mt-1 font-bold">{e.montessori_badge_sub}</p>
              </div>
            </div>
            <div className="flex flex-col justify-between py-2">
              <div className="mb-6">
              ...
              <div className="mt-auto space-y-4 mb-6">
                {e.montessori_principles.map((item, i) => (
              ...
              <div className="p-5 bg-surface rounded-2xl border border-primary/5 mt-auto">
                <p className="text-[#062bad] font-bold italic text-sm">{e.montessori_quote}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-lg border border-slate-100">
              <div className="aspect-video relative bg-slate-100 group">
                <EditableImage src={get('edu_tutor_img', '/images/tutor.jpg')} alt={e.tutor_title} onSave={v => saveKey('edu_tutor_img', v)}
                  className="w-full h-full absolute inset-0" imgClassName="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent pointer-events-none" />
                <div className="absolute bottom-6 left-7">
                  <span className="text-white font-headline font-extrabold text-2xl">{e.tutor_title}</span>
                </div>
              </div>
              <div className="p-8">
                <p className="text-on-surface-muted leading-relaxed mb-6">{e.tutor_desc}</p>
                <div className="space-y-3">
                  {e.tutor_items.map((item, i) => (
            ...
            <div className="bg-gradient-to-br from-[#062bad]/5 to-[#03caff]/5 rounded-[2.5rem] overflow-hidden shadow-lg border border-primary/10">
              <div className="aspect-video relative bg-slate-100 group">
                <EditableImage src={get('edu_coin_img', '/images/coin.jpg')} alt={e.coin_title} onSave={v => saveKey('edu_coin_img', v)}
                  className="w-full h-full absolute inset-0" imgClassName="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#062bad]/70 to-transparent pointer-events-none" />
                <div className="absolute bottom-6 left-7">
                  <span className="text-white font-headline font-extrabold text-2xl">{e.coin_title}</span>
                </div>
              </div>
              <div className="p-8">
                <p className="text-on-surface-muted leading-relaxed mb-6">{e.coin_desc}</p>
